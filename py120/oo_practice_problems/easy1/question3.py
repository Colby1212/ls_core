...
how can we add teh ability for them to go_fast using the mix-in SpeedMixin?
How can you check whether your car or Truck ca now go fast
...
class Car(SpeedMixin):
    def go_slow(self):
        print('I an safe and driving slow.')
