...
class TTTGame:
    ...
    def play_match(self):
        print(f'The first player to win {TTTGame.MATCH_GOAL} games wins the match.')
        ...
        while True:
            ...
            self.dist_player = self.toggle_player(self.first_player)
    ...
    def _join_or(choices, separator=", ", conjunction='or'):
        ...
        return f'{pronpt}{separator}{conjunction} {last}'
